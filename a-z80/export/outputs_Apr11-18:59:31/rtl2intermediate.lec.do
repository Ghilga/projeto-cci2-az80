...
usage -auto -elapse
set log file logs_Apr11-18:59:31/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Apr11-18:59:31/z80_top_direct_n_intermediate.v
} else {
...
write hier_compare dofile outputs_Apr11-18:59:31/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Apr11-18:59:31/hier_rtl2intermediate.lec.do -dynamic_hierarchy
